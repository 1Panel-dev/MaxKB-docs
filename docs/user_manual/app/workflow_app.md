...
![基本信息](../../img/app/start_node.png){width="500px"}
...
![长期记忆](../../img/app/longtime_memory.png)
...
![参数输入](../../img/app/show_hide.png){width="500px"}   
...
!!! Abstract ""
    在高级编排流程中，编写 Python 代码和添加参数创建工具数作为流程中的一个处理节点，以灵活处理复杂需求，自定义工具与创建工具内容一致，详细说明见：[工具](https://maxkb.cn/docs/v2/user_manual/tool/tool/#2)。
...
![禁用/启用](../../img/app/on_off.png){width=500px}
