...
!!! Abstract ""
    - 文件上传： 开启后应用将支持在对话时上传文档、图片文件，并在后续节点中可以对上传后的文件进行解析。
...
!!! Abstract "" 
    ...
    - 返回内容：开启后，在对话过程中，客户端将显示大语言模型的回答结果。
