...
![dataset](../../img/dataset/dataset.png)
...
![创建工作流知识库](../../img/dataset/create_workflow_dataset.png)

#### 1.3.1 工作流编排
!!! Abstract ""
    知识库工作流编排基本流程：数据源 -> 文档解析 -> 文档分段 -> 知识库写入。

![设置工作流知识库](../../img/dataset/set_workflow_dataset.png)
...
![数据源工作流知识库](../../img/dataset/api_workflow_dataset.png)
...
![文档解析工作流知识库](../../img/dataset/doc_workflow_dataset.png){width="300px"}
...
![文档分段工作流知识库](../../img/dataset/docsegmente_workflow_dataset.png){width="500px"}
...
![知识库写入工作流知识库](../../img/dataset/input_workflow_dataset.png){width="300px"}

#### 1.3.2 调试发布
!!! Abstract ""
    编排完成后，点击界面【调试】按钮，系统将按流程执行工作流。

![调试工作流知识库](../../img/dataset/debug_workflow_dataset.png)
...
![执行详情工作流知识库](../../img/dataset/debug_workflow_dataset1.png)

#### 1.3.3 导入文档
!!! Abstract ""
    工作流发布后，用户可以在文档列表中执行【导入文档】操作，【导入文档】与在工作流页面的【调试】功能一致。

![工作流知识库页面](../../img/dataset/main_workflow_dataset.png)
![导入文档工作流知识库](../../img/dataset/import_workflow_dataset.png)
...
![模板中心](../../img/dataset/template_center.png)
...
![导出工作流](../../img/dataset/export_flowdataset.png)

!!! Abstract ""
    **执行记录**

    每次导入文档的操作会记录在工作流的【执行记录】中，用户可按发起人或状态，搜索指定执行记录，实现对所有导入操作的全链路追溯。
![执行记录工作流知识库](../../img/dataset/record_workflow_dataset.png)
...
![发布历史](../../img/dataset/release_history.png)
...
![自动保存](../../img/dataset/auto_save.png)
...
![重新向量化](../../img/dataset/dataset_embedding.png)
...
![生成问题](../../img/dataset/dataset_create_problem.png)
...
![资源授权](../../img/dataset/dataset_resources.png)
...
![关联资源](../../img/dataset/dataset_related_resources.png)
...
![关联资源](../../img/dataset/dataset_move.png)
...
![知识库导出](../../img/dataset/dataset_input.png)
...
![知识库导出](../../img/dataset/export_all_dataset.png)

!!! Abstract ""
    点击【创建】->【导入创建】，选择导出知识库的文件并打开。

![知识库导入](../../img/dataset/input_all_dataset.png)
...
![批量操作](../../img/dataset/batch_operation_dataset.png)
