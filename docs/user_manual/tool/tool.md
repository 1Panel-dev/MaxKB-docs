...
![创建工作流](../../img/fx/add_workflow.png)

!!! Abstract ""
    进入工作流编辑页面，可添加组件或其他工具，进行工作流的编排。

![创建工作流](../../img/fx/edit_workflow.png)
...
![创建工作流](../../img/fx/workflow_basicmsg.png){width="500px"}
...
![创建工作流](../../img/fx/workflow_action.png){width="300px"}

!!! Abstract ""
    其他组件的使用可参照：[基本组件](https://maxkb.cn/docs/v2/user_manual/app/workflow_app/#2)
